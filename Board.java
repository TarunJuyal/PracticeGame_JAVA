...
import com.tarun.game.utils.GameUtils;
...
private void gameOver(Graphics g, String reason) {
	...
	g.drawString(reason, FRAME_WIDTH/2-300, FRAME_HEIGHT/2-50);
	timer.stop();
}
private boolean isCollide(Sprite player, Sprite sprite) {
	...
	return xDistance<=(width-90) && yDistance<=(height-190);
}
...
public void paintComponent(Graphics g) {
	...
	if(isCollide(player,home)) {
		gameOver(g,"U Have Complete the Round");
	}
	for(Spider spider :spiders) {
